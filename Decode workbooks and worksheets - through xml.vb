'From: https://exceloffthegrid.com/removing-cracking-excel-passwords-with-vba/
'1.Rename the file to include the .zip extension.
'2.Open the zip file, navigate to the xml files for workbook and worksheets, remove the protection code
'3.Rename the file back to an xlsx/xlsm.
